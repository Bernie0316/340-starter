...
async function getInventoryByInventoryId(inv_id) {
    try {
        ...
        return data.rows[0]; // 返回庫存項目
    }   catch (error) {
        console.error("getInventoryById error: " + error);
        throw error; // 發生錯誤時拋出異常
    }
}
...
module.exports = {getClassifications, getInventoryByClassificationId, getCarDetails, addClassification, addInventory, updateInventory, deleteInventory, getInventoryByInventoryId}